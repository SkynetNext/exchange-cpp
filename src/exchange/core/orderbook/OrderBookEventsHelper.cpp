...
common::MatcherTradeEvent* OrderBookEventsHelper::SendTradeEvent(
    const common::IOrder* matchingOrder,
    bool makerCompleted,
    bool takerCompleted,
    int64_t size,
...
common::MatcherTradeEvent* OrderBookEventsHelper::SendReduceEvent(const common::IOrder* order,
                                                                  int64_t reduceSize,
                                                                  bool completed) {
    common::MatcherTradeEvent* event = NewMatcherEvent();
...
common::MatcherTradeEvent* OrderBookEventsHelper::SendReduceEvent(int64_t price,
...
::exchange::core::common::MatcherTradeEvent* OrderBookEventsHelper::NewMatcherEvent() {
...
common::MatcherTradeEvent* OrderBookEventsHelper::CreateBinaryEventsChain(
    ...
    const int padding = 5;
    std::vector<int64_t> dataArray = utils::SerializationUtils::BytesToLongArray(bytes, padding);
...
std::map<int32_t, common::Wire> OrderBookEventsHelper::DeserializeEvents(
    const common::cmd::OrderCommand* cmd) {
