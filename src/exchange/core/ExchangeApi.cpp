...
class NewOrderTranslator
  : public disruptor::EventTranslatorOneArg<common::cmd::OrderCommand, common::api::ApiPlaceOrder> {
public:
...
class MoveOrderTranslator
  : public disruptor::EventTranslatorOneArg<common::cmd::OrderCommand, common::api::ApiMoveOrder> {
public:
  void
  translateTo(common::cmd::OrderCommand& cmd, int64_t seq, common::api::ApiMoveOrder api) override {
...
class CancelOrderTranslator
  : public disruptor::EventTranslatorOneArg<common::cmd::OrderCommand, common::api::ApiCancelOrder> {
public:
  void translateTo(common::cmd::OrderCommand& cmd,
                   int64_t seq,
...
class ReduceOrderTranslator
  : public disruptor::EventTranslatorOneArg<common::cmd::OrderCommand, common::api::ApiReduceOrder> {
public:
  void translateTo(common::cmd::OrderCommand& cmd,
                   int64_t seq,
...
public:
  void
  translateTo(common::cmd::OrderCommand& cmd, int64_t seq, common::api::ApiAddUser api) override {
...
class SuspendUserTranslator
  : public disruptor::EventTranslatorOneArg<common::cmd::OrderCommand, common::api::ApiSuspendUser> {
public:
  void translateTo(common::cmd::OrderCommand& cmd,
                   int64_t seq,
...
class ResumeUserTranslator
  : public disruptor::EventTranslatorOneArg<common::cmd::OrderCommand, common::api::ApiResumeUser> {
public:
  void translateTo(common::cmd::OrderCommand& cmd,
                   int64_t seq,
...
public:
  void
  translateTo(common::cmd::OrderCommand& cmd, int64_t seq, common::api::ApiReset api) override {
...
public:
  void translateTo(common::cmd::OrderCommand& cmd, int64_t seq, common::api::ApiNop api) override {
  ...
  if (auto* binaryData = dynamic_cast<common::api::ApiBinaryDataCommand*>(cmd)) {
    ...
    return std::async(std::launch::deferred,
                      [future = std::move(future), future2 = std::move(future2)]() mutable {
                        ...
                        std::vector<common::cmd::CommandResultCode> results = {result1, result2};
...
ExchangeApi<WaitStrategyT>::SubmitCommandAsyncFullResponse(common::api::ApiCommand* cmd) {
  if (!cmd) {
  ...
  if (auto* binaryData = dynamic_cast<common::api::ApiBinaryDataCommand*>(cmd)) {
    ...
    throw std::invalid_argument("SubmitCommandAsyncFullResponse: BinaryDataCommand not supported");
  } else if (auto* persistState = dynamic_cast<common::api::ApiPersistState*>(cmd)) {
...
void ExchangeApi<WaitStrategyT>::SubmitCommandsBatch(
  ...
  for (size_t i = 0; i < batchSize; i++) {
    ...
    if (auto* placeOrder = dynamic_cast<common::api::ApiPlaceOrder*>(apiCmd)) {
    ...
    } else if (auto* orderBookRequest = dynamic_cast<common::api::ApiOrderBookRequest*>(apiCmd)) {
      ...
      throw std::invalid_argument("SubmitCommandsBatch: BinaryDataCommand not supported in batch");
