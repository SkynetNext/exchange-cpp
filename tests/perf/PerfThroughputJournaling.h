 ...
 */
class PerfThroughputJournaling : public ::testing::Test {
public:
  /**
   * Throughput test with journaling for simplified conditions
   * - one symbol
  ...
  /**
   * Throughput test with journaling for Exchange mode
   */
  void TestThroughputExchange();

  /**
   * Throughput test with journaling for medium multi-symbol configuration
  ...
  /**
   * Throughput test with journaling for large multi-symbol configuration
  ...
  /**
   * Throughput test with journaling for huge multi-symbol configuration
   * This is high load throughput test for verifying exchange core scalability:
