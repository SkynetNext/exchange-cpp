...
std::unique_ptr<ExchangeTestContainer> ExchangeTestContainer::Create(
  ...
  return Create(perfCfg, exchange::core::common::config::InitialStateConfiguration::CleanTest(),
...
ExchangeTestContainer::ExchangeTestContainer(
  ...
  exchange::core::common::config::PerformanceConfiguration perfCfgCopy(
    perfCfg.ringBufferSize, perfCfg.matchingEnginesNum, perfCfg.riskEnginesNum,
    perfCfg.msgsInGroupLimit, perfCfg.maxGroupDurationNs, perfCfg.sendL2ForEveryCmd,
    perfCfg.l2RefreshDepth, perfCfg.waitStrategy, perfCfg.threadFactory, perfCfg.orderBookFactory);
  ...
  exchange::core::common::config::ExchangeConfiguration exchangeConfiguration(
    ...
    exchange::core::common::config::LoggingConfiguration::Default(), serializationCfg);

  // Create results consumer
  auto resultsConsumer = [this](exchange::core::common::cmd::OrderCommand* cmd, int64_t seq) {
    if (consumer_) {
      consumer_(cmd, seq);
    }
  };
  ...
  // Create ExchangeCore
  exchangeCore_ =
    std::make_unique<exchange::core::ExchangeCore>(resultsConsumer, &exchangeConfiguration);
...
// Move constructor
ExchangeTestContainer::ExchangeTestContainer(ExchangeTestContainer&& other) noexcept
...
// Move assignment
ExchangeTestContainer& ExchangeTestContainer::operator=(ExchangeTestContainer&& other) noexcept {
  if (this != &other) {
    exchangeCore_ = std::move(other.exchangeCore_);
    api_ = other.api_;
    uniqueIdCounterLong_ = other.uniqueIdCounterLong_.load();
...
void ExchangeTestContainer::InitBasicUser(int64_t uid) {
  ...
  if (result1.get() != exchange::core::common::cmd::CommandResultCode::SUCCESS) {
  ...
  if (result2.get() != exchange::core::common::cmd::CommandResultCode::SUCCESS) {
  ...
  if (result3.get() != exchange::core::common::cmd::CommandResultCode::SUCCESS) {
  ...
  if (result4.get() != exchange::core::common::cmd::CommandResultCode::SUCCESS) {
...
void ExchangeTestContainer::InitFeeUser(int64_t uid) {
  ...
  if (result5.get() != exchange::core::common::cmd::CommandResultCode::SUCCESS) {
    throw std::runtime_error("Failed to adjust balance LTC");
  }
}

// Create user with money
void ExchangeTestContainer::CreateUserWithMoney(int64_t uid, int32_t currency, int64_t amount) {
  std::vector<exchange::core::common::api::ApiCommand*> cmds;
  cmds.push_back(new exchange::core::common::api::ApiAddUser(uid));
  cmds.push_back(new exchange::core::common::api::ApiAdjustUserBalance(uid, currency, amount,
...
void ExchangeTestContainer::AddMoneyToUser(int64_t uid, int32_t currency, int64_t amount) {
  std::vector<exchange::core::common::api::ApiCommand*> cmds;
  cmds.push_back(new exchange::core::common::api::ApiAdjustUserBalance(uid, currency, amount,
                                                                       GetRandomTransactionId()));
  api_->SubmitCommandsSync(cmds);
...
void ExchangeTestContainer::AddSymbol(
  ...
  auto batchCmd =
    std::make_unique<exchange::core::common::api::binary::BatchAddSymbolsCommand>(&symbol);
...
void ExchangeTestContainer::AddSymbols(
  ...
  for (size_t i = 0; i < symbols.size(); i += chunkSize) {
    ...
    auto batchCmd =
      std::make_unique<exchange::core::common::api::binary::BatchAddSymbolsCommand>(chunkPtrs);
    SendBinaryDataCommandSync(std::move(batchCmd), 5000);
  }
}
...
void ExchangeTestContainer::SendBinaryDataCommandSync(
  ...
  int timeOutMs) {
  auto binaryCmd = std::make_unique<exchange::core::common::api::ApiBinaryDataCommand>(
...
void ExchangeTestContainer::UserAccountsInit(const std::vector<std::vector<bool>>& userCurrencies) {
...
void ExchangeTestContainer::UsersInit(int numUsers, const std::set<int32_t>& currencies) {
  std::vector<exchange::core::common::api::ApiCommand*> cmds;
...
void ExchangeTestContainer::ResetExchangeCore() {
  ...
  auto result = future.get();
  if (result != exchange::core::common::cmd::CommandResultCode::SUCCESS) {
    throw std::runtime_error("Reset failed with code: " + std::to_string(static_cast<int>(result)));
  }
}
...
void ExchangeTestContainer::SubmitCommandSync(
  ...
  if (result != expectedResultCode) {
    throw std::runtime_error("Command failed: expected "
...
ExchangeTestContainer::GetUserProfile(int64_t clientId) {
  auto query =
    std::make_unique<exchange::core::common::api::reports::SingleUserReportQuery>(clientId);
  ...
  try {
    auto future = exchange::core::ProcessReportHelper<
      ...
      exchange::core::common::api::reports::SingleUserReportResult>(api_, std::move(query),
                                                                    GetRandomTransferId());
    return future.get();
...
ExchangeTestContainer::TotalBalanceReport() {
  auto query =
    std::make_unique<exchange::core::common::api::reports::TotalCurrencyBalanceReportQuery>();
...
int32_t ExchangeTestContainer::RequestStateHash() {
  auto query = std::make_unique<exchange::core::common::api::reports::StateHashReportQuery>();
  ...
  auto future = api_->ProcessReportAny(query->GetReportTypeCode(), std::move(queryBytes),
                                       GetRandomTransferId());
...
ConvertOrderCommandToApiCommand(const exchange::core::common::cmd::OrderCommand& cmd) {
  switch (cmd.command) {
    ...
    case exchange::core::common::cmd::OrderCommandType::MOVE_ORDER:
      return new exchange::core::common::api::ApiMoveOrder(cmd.orderId, cmd.price, cmd.uid,
                                                           cmd.symbol);
    case exchange::core::common::cmd::OrderCommandType::CANCEL_ORDER:
      return new exchange::core::common::api::ApiCancelOrder(cmd.orderId, cmd.uid, cmd.symbol);
    case exchange::core::common::cmd::OrderCommandType::REDUCE_ORDER:
      return new exchange::core::common::api::ApiReduceOrder(cmd.orderId, cmd.uid, cmd.symbol,
                                                             cmd.size);
    default:
      return nullptr;
  }
...
void ExchangeTestContainer::LoadSymbolsUsersAndPrefillOrders(
  ...
  // Load symbols
  auto coreSymbolSpecifications =
    const_cast<TestDataFutures&>(testDataFutures).coreSymbolSpecifications.get();
...
void ExchangeTestContainer::SetConsumer(
  std::function<void(exchange::core::common::cmd::OrderCommand*, int64_t)> consumer) {
...
void ExchangeTestContainer::CreateUserAccountsRegular(
  ...
  for (int uid = 1; uid <= numUsers; uid++) {
    cmds.push_back(new exchange::core::common::api::ApiAddUser(uid));
    for (size_t currencyIdx = 0; currencyIdx < userCurrencies[uid].size(); currencyIdx++) {
...
TestDataFutures
ExchangeTestContainer::PrepareTestDataAsync(const util::TestDataParameters& parameters, int seed) {
  ...
  futures.coreSymbolSpecifications =
    std::async(std::launch::async, [&parameters]() {
      return ExchangeTestContainer::GenerateRandomSymbols(
        parameters.numSymbols, parameters.currenciesAllowed, parameters.allowedSymbolTypes);
  ...
  futures.genResult =
    std::async(std::launch::async, [&parameters, seed]() {
      ...
      auto symbols = ExchangeTestContainer::GenerateRandomSymbols(
        parameters.numSymbols, parameters.currenciesAllowed, parameters.allowedSymbolTypes);
      auto users = UserCurrencyAccountsGenerator::GenerateUsers(parameters.numAccounts,
...
ExchangeTestContainer::GenerateRandomSymbols(int num,
  ...
  std::vector<int32_t> currencies(currenciesAllowed.begin(), currenciesAllowed.end());
  ...
  switch (allowedSymbolTypes) {
    case util::AllowedSymbolTypes::FUTURES_CONTRACT:
      symbolTypeSupplier = []() { return exchange::core::common::SymbolType::FUTURES_CONTRACT; };
      break;
    ...
    default:
      symbolTypeSupplier = [&rng]() {
        return (rng() % 2 == 0) ? exchange::core::common::SymbolType::FUTURES_CONTRACT
