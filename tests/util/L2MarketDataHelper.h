...
public:
  ...
  L2MarketDataHelper &SetAskPriceVolume(int pos, int64_t askPrice,
                                        int64_t askVolume);
  L2MarketDataHelper &SetBidPriceVolume(int pos, int64_t bidPrice,
                                        int64_t bidVolume);
  ...
  std::string
  DumpOrderBook(const exchange::core::common::L2MarketData &l2MarketData) const;
...
private:
  ...
  static int MaxWidth(int minWidth, const std::vector<int64_t> &arr1,
