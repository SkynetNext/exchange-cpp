...
static const ankerl::unordered_dense::map<int32_t, int64_t> &GetFees(
    const exchange::core::common::api::reports::TotalCurrencyBalanceReportResult
        &result) {
  if (!result.fees) {
...
TEST_F(ITFeesExchangeBasic, ShouldRequireTakerFees_GtcCancel) {
  ...
  container->CreateUserWithMoney(TestConstants::UID_2,
                                 TestConstants::CURRENCY_LTC, ltcAmount);
  ...
  container->SubmitCommandSync(std::move(order203),
                               CommandResultCode::RISK_NSF);

  // add fee-1 - NSF
  container->AddMoneyToUser(TestConstants::UID_2, TestConstants::CURRENCY_LTC,
                            takerFee * 30 - 1);
  ...
  container->SubmitCommandSync(std::move(cancelCmd),
  ...
  container->AddMoneyToUser(TestConstants::UID_2, TestConstants::CURRENCY_XBT,
                            btcAmount);
  ...
  container->SubmitCommandSync(std::move(cancelCmd2),
                               CommandResultCode::SUCCESS);
...
TEST_F(ITFeesExchangeBasic, ShouldProcessFees_BidGtcMaker_AskIocTakerPartial) {
  ...
  container->CreateUserWithMoney(TestConstants::UID_1,
                                 TestConstants::CURRENCY_LTC,
  ...
  auto order101 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      11'500L, 1731L, 101L, OrderAction::BID, OrderType::GTC,
      TestConstants::UID_1, TestConstants::SYMBOL_EXCHANGE_FEE, 0, 11'553L);
  ...
  const int64_t expectedFundsLtc =
      ltcAmount - (11'553L * step + takerFee) * 1731L;
  ...
  container->CreateUserWithMoney(TestConstants::UID_2,
                                 TestConstants::CURRENCY_XBT, btcAmount);
  ...
  auto order102 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      11'493L, 2000L, 102, OrderAction::ASK, OrderType::IOC,
      TestConstants::UID_2, TestConstants::SYMBOL_EXCHANGE_FEE, 0, 0);
  container->SubmitCommandSync(
      std::move(order102),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
        EXPECT_EQ(cmd.resultCode, CommandResultCode::SUCCESS);
  ...
  container->ValidateUserState(
      TestConstants::UID_2,
      [btcAmount, takerFee, step, &symbolSpec](
          const exchange::core::common::api::reports::SingleUserReportResult
              &profile) {
        ASSERT_NE(profile.accounts, nullptr);
        auto ltcIt = profile.accounts->find(TestConstants::CURRENCY_LTC);
...
TEST_F(ITFeesExchangeBasic, ShouldProcessFees_BidGtcMakerPartial_AskIocTaker) {
  ...
  auto order102 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      11'493L, 1000L, 102, OrderAction::ASK, OrderType::IOC,
      TestConstants::UID_2, TestConstants::SYMBOL_EXCHANGE_FEE, 0, 0);
  container->SubmitCommandSync(
      std::move(order102),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
  ...
  container->ValidateUserState(
      TestConstants::UID_1,
      [ltcAmount, makerFee, takerFee, step, &symbolSpec](
          const exchange::core::common::api::reports::SingleUserReportResult
              &profile) {
        ASSERT_NE(profile.accounts, nullptr);
        auto ltcIt = profile.accounts->find(TestConstants::CURRENCY_LTC);
        EXPECT_NE(ltcIt, profile.accounts->end());
        EXPECT_EQ(ltcIt->second, ltcAmount -
                                     (11'500L * step + makerFee) * 1000L -
...
TEST_F(ITFeesExchangeBasic, ShouldProcessFees_AskGtcMaker_BidIocTakerPartial) {
  ...
  // x10,000 step)
  auto order101 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      11'500L, 2000L, 101L, OrderAction::ASK, OrderType::GTC,
      TestConstants::UID_1, TestConstants::SYMBOL_EXCHANGE_FEE, 0, 11'500L);
  container->SubmitCommandSync(
      std::move(order101),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
        EXPECT_EQ(cmd.resultCode, CommandResultCode::SUCCESS);
  ...
  auto order102 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      11'521L, 2197L, 102, OrderAction::BID, OrderType::IOC,
      TestConstants::UID_2, TestConstants::SYMBOL_EXCHANGE_FEE, 0, 11'659L);
  container->SubmitCommandSync(
      std::move(order102),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
        EXPECT_EQ(cmd.resultCode, CommandResultCode::SUCCESS);
  ...
  container->ValidateUserState(
      TestConstants::UID_2,
      [ltcAmount, btcAmount, takerFee, step, &symbolSpec](
          const exchange::core::common::api::reports::SingleUserReportResult
              &profile) {
        ASSERT_NE(profile.accounts, nullptr);
        auto xbtIt = profile.accounts->find(TestConstants::CURRENCY_XBT);
        ...
        EXPECT_NE(ltcIt, profile.accounts->end());
        EXPECT_EQ(ltcIt->second,
                  ltcAmount - (11'500L * step + takerFee) * 2000L);
        // Check orders are empty
        if (profile.orders) {
          bool hasOrders = false;
          for (const auto &[symbolId, orderList] : *profile.orders) {
...
TEST_F(ITFeesExchangeBasic, ShouldProcessFees_AskGtcMakerPartial_BidIocTaker) {
  ...
  auto order102 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      11'521L, 1997L, 102, OrderAction::BID, OrderType::IOC,
      TestConstants::UID_2, TestConstants::SYMBOL_EXCHANGE_FEE, 0, 11'659L);
  container->SubmitCommandSync(
      std::move(order102),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
  ...
  container->ValidateUserState(
      TestConstants::UID_1,
      [makerFee,
       step](const exchange::core::common::api::reports::SingleUserReportResult
                 &profile) {
        ASSERT_NE(profile.accounts, nullptr);
        auto xbtIt = profile.accounts->find(TestConstants::CURRENCY_XBT);
        EXPECT_NE(xbtIt, profile.accounts->end());
  ...
  container->ValidateUserState(
      TestConstants::UID_2,
      [ltcAmount, takerFee, step, &symbolSpec](
          const exchange::core::common::api::reports::SingleUserReportResult
              &profile) {
        ASSERT_NE(profile.accounts, nullptr);
        auto xbtIt = profile.accounts->find(TestConstants::CURRENCY_XBT);
        ...
        EXPECT_NE(ltcIt, profile.accounts->end());
        EXPECT_EQ(ltcIt->second,
                  ltcAmount - (11'500L * step + takerFee) * 1997L);
        // Check orders are empty
        if (profile.orders) {
          bool hasOrders = false;
          for (const auto &[symbolId, orderList] : *profile.orders) {
