...
TEST_F(ITFeesMarginBasic, ShouldProcessFees_AskGtcMakerPartial_BidIocTaker) {
  ...
  container->CreateUserWithMoney(TestConstants::UID_1,
                                 TestConstants::CURRENCY_JPY, jpyAmount1);

  auto order101 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      10770L, 40L, 101L, OrderAction::ASK, OrderType::GTC, TestConstants::UID_1,
      symbolId, 0, 0L);
  ...
  container->CreateUserWithMoney(TestConstants::UID_2,
                                 TestConstants::CURRENCY_JPY, jpyAmount2);
  ...
  auto order102 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      10770L, 30L, 102, OrderAction::BID, OrderType::IOC, TestConstants::UID_2,
      symbolId, 0, 10770L);
  container->SubmitCommandSync(
      std::move(order102),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
...
TEST_F(ITFeesMarginBasic, ShouldProcessFees_BidGtcMakerPartial_AskIocTaker) {
  ...
  auto order101 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      10770L, 50L, 101L, OrderAction::BID, OrderType::GTC, TestConstants::UID_1,
      symbolId, 0, 0L);
  container->SubmitCommandSync(
      std::move(order101),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
  ...
  auto order102 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
      10770L, 30L, 102, OrderAction::ASK, OrderType::IOC, TestConstants::UID_2,
      symbolId, 0, 10770L);
  container->SubmitCommandSync(
      std::move(order102),
      [](const exchange::core::common::cmd::OrderCommand &cmd) {
