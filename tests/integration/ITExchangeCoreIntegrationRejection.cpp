...
ITExchangeCoreIntegrationRejection::ITExchangeCoreIntegrationRejection()
  : processor_(std::make_unique<exchange::core::SimpleEventsProcessor>(&mockHandler_)) {}
...
ITExchangeCoreIntegrationRejection::BuilderPlace(int32_t symbolId,
                                                 int64_t uid,
  ...
  return exchange::core::common::api::ApiPlaceOrder(0, 0, 0, action, type, uid, symbolId, 0, 0);
}
...
void ITExchangeCoreIntegrationRejection::TestMultiBuy(
  ...
  const int64_t size = 40L + (rejectionCause == RejectionCause::REJECTION_BY_SIZE ? 1 : 0);
  ...
  if (orderType == OrderType::FOK_BUDGET && rejectionCause != RejectionCause::NO_REJECTION) {
    ...
    EXPECT_CALL(mockHandler_, TradeEvent(_))
      .WillOnce([symbolId, rejectionCause](const exchange::core::TradeEvent& evt) {
        ...
        EXPECT_EQ(evt.takeOrderCompleted, rejectionCause == RejectionCause::NO_REJECTION);
      });
  }
  ...
  if (rejectionCause != RejectionCause::NO_REJECTION && orderType != OrderType::GTC) {
    ...
    int64_t expectedRejectedVolume = (orderType == OrderType::FOK_BUDGET) ? size : 1L;
    EXPECT_CALL(mockHandler_, RejectEvent(_))
      .WillOnce([symbolId, expectedRejectedVolume](const exchange::core::RejectEvent& evt) {
        EXPECT_EQ(evt.symbol, symbolId);
  ...
  container->SetConsumer([this](exchange::core::common::cmd::OrderCommand* cmd, int64_t seq) {
    if (processor_) {
  ...
  auto order101 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    160000L, 7L, 101L, OrderAction::ASK, OrderType::GTC, TestConstants::UID_1, symbolId, 0, 0);
  ...
  auto order202 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    159900L, 10L, 202L, OrderAction::ASK, OrderType::GTC, TestConstants::UID_2, symbolId, 0, 0);
  ...
  auto order303 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    160000L, 3L, 303L, OrderAction::ASK, OrderType::GTC, TestConstants::UID_3, symbolId, 0, 0);
  ...
  auto order304 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    160500L, 20L, 304L, OrderAction::ASK, OrderType::GTC, TestConstants::UID_3, symbolId, 0, 0);
  ...
  auto order405 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    price, size, 405L, OrderAction::BID, orderType, TestConstants::UID_4, symbolId, 0, price);
...
void ITExchangeCoreIntegrationRejection::TestMultiSell(
  ...
  RejectionCause rejectionCause) {
  const int32_t symbolId = symbolSpec.symbolId;
  const int64_t size = 22L + (rejectionCause == RejectionCause::REJECTION_BY_SIZE ? 1 : 0);
  ...
  auto order101 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    160000L, 12L, 101L, OrderAction::BID, OrderType::GTC, TestConstants::UID_1, symbolId, 0,
    166000L);
  container->SubmitCommandSync(std::move(order101), CommandResultCode::SUCCESS);

  auto order202 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    159900L, 1L, 202L, OrderAction::BID, OrderType::GTC, TestConstants::UID_2, symbolId, 0,
    166000L);
  container->SubmitCommandSync(std::move(order202), CommandResultCode::SUCCESS);

  auto order303 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    160000L, 8L, 303L, OrderAction::BID, OrderType::GTC, TestConstants::UID_3, symbolId, 0,
    166000L);
  container->SubmitCommandSync(std::move(order303), CommandResultCode::SUCCESS);

  auto order304 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    160500L, 1L, 304L, OrderAction::BID, OrderType::GTC, TestConstants::UID_3, symbolId, 0,
    166000L);
  container->SubmitCommandSync(std::move(order304), CommandResultCode::SUCCESS);

  // Submit ASK order
  auto order405 = std::make_unique<exchange::core::common::api::ApiPlaceOrder>(
    price, size, 405L, OrderAction::ASK, orderType, TestConstants::UID_4, symbolId, 0, 0);
  container->SubmitCommandSync(std::move(order405), CommandResultCode::SUCCESS);
