...
protected:
  ...
  virtual std::unique_ptr<exchange::core::orderbook::IOrderBook>
  CreateNewOrderBook() = 0;

  virtual exchange::core::common::CoreSymbolSpecification
  GetCoreSymbolSpec() = 0;
  ...
  void CheckEventTrade(const exchange::core::common::MatcherTradeEvent *event,
                       int64_t matchedId, int64_t price, int64_t size);

  void
  CheckEventRejection(const exchange::core::common::MatcherTradeEvent *event,
  ...
  void CheckEventReduce(const exchange::core::common::MatcherTradeEvent *event,
                        int64_t reduceSize, int64_t price, bool completed,
                        int64_t *bidderHoldPrice = nullptr);
