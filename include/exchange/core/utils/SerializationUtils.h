...
public:
   ...
   */
  static void MarshallIntLongHashMap(const ankerl::unordered_dense::map<int32_t, int64_t>& hashMap,
                                     common::BytesOut& bytes);

  /**
   * Read int->long hash map
   */
  static ankerl::unordered_dense::map<int32_t, int64_t> ReadIntLongHashMap(common::BytesIn& bytes);
