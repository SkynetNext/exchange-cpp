...
public:
   ...
   * OrderCommand::marketData)
   */
  std::future<std::shared_ptr<common::L2MarketData>> RequestOrderBookAsync(int32_t symbolId,
...
ProcessReportHelper(IExchangeApi* api, std::unique_ptr<Q> query, int32_t transferId) {
