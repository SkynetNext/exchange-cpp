 ...
 */
class UserProfileService : public common::StateHash, public common::WriteBytesMarshallable {
public:
  // uid -> UserProfile
   ...
   */
  explicit UserProfileService(common::BytesIn* bytes);
  ...
  BalanceAdjustment(int64_t uid, int32_t currency, int64_t amount, int64_t fundingTransactionId);
