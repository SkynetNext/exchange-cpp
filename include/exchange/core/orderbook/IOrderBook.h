...
public:
   ...
   */
  virtual common::cmd::CommandResultCode CancelOrder(common::cmd::OrderCommand* cmd) = 0;

  /**
   * Decrease the size of the order
   * Fills cmd.action with original order action
   */
  virtual common::cmd::CommandResultCode ReduceOrder(common::cmd::OrderCommand* cmd) = 0;

  /**
   * Move order to new price
   * Fills cmd.action with original order action
   */
  virtual common::cmd::CommandResultCode MoveOrder(common::cmd::OrderCommand* cmd) = 0;
   ...
   */
  virtual void ProcessAskOrders(std::function<void(const common::IOrder*)> consumer) const = 0;
   ...
   * @param consumer Callback function that receives each order
   */
  virtual void ProcessBidOrders(std::function<void(const common::IOrder*)> consumer) const = 0;
   ...
   */
  static common::cmd::CommandResultCode ProcessCommand(IOrderBook* orderBook,
