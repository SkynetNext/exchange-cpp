...
| 操作/组件 | 最小值 | 典型范围 | 周期数（最小值） | 备注 |
|---------|--------|---------|-----------------|------|
| **━━━ 纳秒级（ns）━━━** | | | | |
| **L1 cache hit** | 0.5ns | 0.5-1ns | 1-2 | ⭐ 最快 |
| **L2 cache hit** | 3ns | 3-5ns | 9-15 | |
| **直接函数调用** | ~6ns | ~6ns | ~18 | |
| **L3 cache hit** | 10ns | 10-20ns | 30-60 | |
| **虚函数调用** | ~14ns | ~14ns | ~42 | |
| **StoreLoad barrier** | 15ns | 15-25ns | 45-75 | |
| **Lock-free CAS** | 15ns | 15-30ns | 45-90 | |
| **std::function调用** | 20ns | 20-33ns | 60-100 | |
| **Mutex lock/unlock** | 25ns | 25-50ns | 75-150 | |
| **Disruptor** | 50ns | 50-200ns | 150-600 | |
| **LMAX Mean Latency** | 52ns | 52ns | ~156 | 基准值 |
| **DDR4主内存** | 60ns | 60-80ns | 180-240 | |
| **━━━ 微秒级（μs）━━━** | | | | |
| **Aeron IPC** | 0.3μs | 0.3-1μs | 900-3000 | |
| **localhost UDP** | 0.5μs | 0.5-2μs | 1500-6000 | |
| **RDMA (InfiniBand)** | 1μs | 1-10μs | 3K-30K | ⭐ 最低网络延迟 |
| **Thread context switch** | 1μs | 1-5μs | 3K-15K | |
| **RDMA (RoCE)** | 2μs | 2-15μs | 6K-45K | |
| **Cilium eBPF转发** | 5μs | 5-50μs | 15K-150K | |
| **localhost TCP** | 5μs | 5-10μs | 15K-30K | |
| **云商同机房网络** | 10μs | 10-100μs | 30K-300K | |
| **NVMe SSD随机读取** | 20μs | 20-100μs | 60K-300K | |
| **SATA SSD随机读取** | 50μs | 50-100μs | 150K-300K | |
| **━━━ 毫秒级（ms）━━━** | | | | |
| **跨AZ网络** | 0.1ms | 0.1-1ms | 300K-3M | AZ=可用区（Availability Zone） |
| **Cilium eBPF跨AZ RTT** | ~0.55ms | ~0.55ms | ~1.65M | 跨可用区往返延迟 |
| **HDD (15000 RPM)** | ~2ms | ~2ms | ~6M | |
| **HDD (7200 RPM)** | 8ms | 8-12ms | 24M-36M | ⚠️ 最慢 |
